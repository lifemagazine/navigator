...
public class Railport implements IPort, Serializable {
	...
	public Railport(String key, String name, boolean isHub, String countryCode, String locationCode, double latitude, double longitude) {
		this.key = key;
		this.type = PortEnum.RAILPORT;
		this.name = name;
		this.isHub = isHub;
