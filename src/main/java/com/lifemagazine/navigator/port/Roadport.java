...
public class Roadport implements IPort, Serializable {
	...
	public Roadport(String key, String name, boolean isHub, String countryCode, String locationCode, double latitude, double longitude) {
		this.key = key;
		this.type = PortEnum.ROADPORT;
		this.name = name;
		this.isHub = isHub;
