...
public class Seaport implements IPort, Serializable {
	...
	public Seaport(String key, String name, boolean isHub, String countryCode, String locationCode, double latitude, double longitude) {
		this.key = key;
		this.type = PortEnum.SEAPORT;
		this.name = name;
		this.isHub = isHub;
